        ...
        input=[
            {
                ...
                "content": (
                    ...
                    "A band's concert tour is a concert, not tourism. Do not infer tourism from the word 'Tour' "
                    "in a musical tour title. A band or performer at Ari Standup is a stand-up show (party), "
                    "not tourism. The word 'Дети' in a song, album, or concert program title does not make "
                    "an event for children; use kids only when the audience is explicitly children. "
                    ...
                    "When the heading or introduction explicitly says that the whole schedule belongs to one venue, "
                    "copy that shared venue into every extracted event. Do not copy a venue across a mixed city digest "
                    "or use a district, tour subject, organizer office, or destination as a meeting point. "
